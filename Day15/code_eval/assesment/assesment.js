...
// Adding contacts
manager.addContact({ id: 1, name: "pinky", email: "pinky@example.com", phone: "1234567890" });
manager.addContact({ id: 2, name: "timmu", email: "timmu@example.com", phone: "9876543210" });
// Viewing contacts
console.log("Contact List:", manager.viewContacts());
// Modifying a contact
manager.modifyContact(1, { email: "pinky @example.com" });
// Deleting a contact
